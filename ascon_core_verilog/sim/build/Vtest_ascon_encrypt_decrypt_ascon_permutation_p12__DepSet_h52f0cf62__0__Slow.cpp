...
VL_ATTR_COLD void Vtest_ascon_encrypt_decrypt_ascon_permutation_p12___stl_sequent__TOP__test_ascon_encrypt_decrypt__DOT__ascon_initialization_dut__DOT__ascon_p12__0(Vtest_ascon_encrypt_decrypt_ascon_permutation_p12* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_ascon_encrypt_decrypt_ascon_permutation_p12___stl_sequent__TOP__test_ascon_encrypt_decrypt__DOT__ascon_initialization_dut__DOT__ascon_p12__0\n"); );
    ...
    vlSelfRef.r0__DOT____VdfgRegularize_h66faf083_0_1 
        = (0xf0ULL ^ (((0U == (IData)(vlSymsp->TOP.test_ascon_encrypt_decrypt__DOT__sel_type))
                        ? (((QData)((IData)(vlSymsp->TOP.test_ascon_encrypt_decrypt__DOT__key[1U])) 
                            << 0x20U) | (QData)((IData)(
                                                        vlSymsp->TOP.test_ascon_encrypt_decrypt__DOT__key[0U])))
                        : 0ULL) ^ vlSymsp->TOP.test_ascon_encrypt_decrypt__DOT__ascon_initialization_dut__DOT____Vcellinp__ascon_p12__x1_i));

...
VL_ATTR_COLD void Vtest_ascon_core___024root___eval_initial__TOP(Vtest_ascon_core___024root* vlSelf) {
    ...
    test_ascon_core__DOT__unnamedblk2__DOT__i = 0;
    CData/*0:0*/ test_ascon_core__DOT__unnamedblk2__DOT__i__Vfirst;
    test_ascon_core__DOT__unnamedblk2__DOT__i__Vfirst = 0;
    IData/*31:0*/ test_ascon_core__DOT__unnamedblk4__DOT__i;
    test_ascon_core__DOT__unnamedblk4__DOT__i = 0;
    CData/*0:0*/ test_ascon_core__DOT__unnamedblk4__DOT__i__Vfirst;
    test_ascon_core__DOT__unnamedblk4__DOT__i__Vfirst = 0;
    ...
    if (VL_UNLIKELY((0U != vlSelfRef.test_ascon_core__DOT__PLAINTEXT.first(test_ascon_core__DOT__unnamedblk2__DOT__i)))) {
        test_ascon_core__DOT__unnamedblk2__DOT__i__Vfirst = 1U;
        while (((IData)(test_ascon_core__DOT__unnamedblk2__DOT__i__Vfirst) 
                || (0U != vlSelfRef.test_ascon_core__DOT__PLAINTEXT.next(test_ascon_core__DOT__unnamedblk2__DOT__i)))) {
            test_ascon_core__DOT__unnamedblk2__DOT__i__Vfirst = 0U;
            VL_ASSIGN_W(128,__Vtemp_10, vlSelfRef.test_ascon_core__DOT__PLAINTEXT
                        .at(test_ascon_core__DOT__unnamedblk2__DOT__i));
            VL_WRITEF_NX("PLAINTEXT[%3d] = %x\n",0,
                         32,test_ascon_core__DOT__unnamedblk2__DOT__i,
                         128,__Vtemp_10.data());
        }
    }
    ...
    while (VL_LTS_III(32, vlSelfRef.test_ascon_core__DOT__unnamedblk3__DOT__i, vlSelfRef.test_ascon_core__DOT__data_read_file_ass_data.size())) {
        VL_CONCAT_WQQ(128,64,64, __Vtemp_11, vlSelfRef.test_ascon_core__DOT__data_read_file_ass_data
                      .at(vlSelfRef.test_ascon_core__DOT__unnamedblk3__DOT__i), vlSelfRef.test_ascon_core__DOT__data_read_file_ass_data
                      .at(((IData)(1U) + vlSelfRef.test_ascon_core__DOT__unnamedblk3__DOT__i)));
        VL_ASSIGN_W(128,vlSelfRef.test_ascon_core__DOT__ASS_DATA
                    .at(vlSelfRef.test_ascon_core__DOT__count), __Vtemp_11);
        vlSelfRef.test_ascon_core__DOT__count = ((IData)(1U) 
                                                 + vlSelfRef.test_ascon_core__DOT__count);
        vlSelfRef.test_ascon_core__DOT__unnamedblk3__DOT__i 
            = ((IData)(2U) + vlSelfRef.test_ascon_core__DOT__unnamedblk3__DOT__i);
    }
    if (VL_UNLIKELY((0U != vlSelfRef.test_ascon_core__DOT__ASS_DATA.first(test_ascon_core__DOT__unnamedblk4__DOT__i)))) {
        test_ascon_core__DOT__unnamedblk4__DOT__i__Vfirst = 1U;
        while (((IData)(test_ascon_core__DOT__unnamedblk4__DOT__i__Vfirst) 
                || (0U != vlSelfRef.test_ascon_core__DOT__ASS_DATA.next(test_ascon_core__DOT__unnamedblk4__DOT__i)))) {
            test_ascon_core__DOT__unnamedblk4__DOT__i__Vfirst = 0U;
            VL_ASSIGN_W(128,__Vtemp_14, vlSelfRef.test_ascon_core__DOT__ASS_DATA
                        .at(test_ascon_core__DOT__unnamedblk4__DOT__i));
            VL_WRITEF_NX("ASS_DATA[%3d] = %x\n",0,32,
                         test_ascon_core__DOT__unnamedblk4__DOT__i,
                         128,__Vtemp_14.data());
        }
    }
    ...
    vlSelfRef.test_ascon_core__DOT__count = 0U;
    vlSelfRef.test_ascon_core__DOT__unnamedblk5__DOT__i = 1U;
    while (VL_LTS_III(32, vlSelfRef.test_ascon_core__DOT__unnamedblk5__DOT__i, vlSelfRef.test_ascon_core__DOT__data_read_file_ciphertext.size())) {
        VL_CONCAT_WQQ(128,64,64, __Vtemp_15, vlSelfRef.test_ascon_core__DOT__data_read_file_ciphertext
                      .at(vlSelfRef.test_ascon_core__DOT__unnamedblk5__DOT__i), vlSelfRef.test_ascon_core__DOT__data_read_file_ciphertext
                      .at(((IData)(1U) + vlSelfRef.test_ascon_core__DOT__unnamedblk5__DOT__i)));
        VL_ASSIGN_W(128,vlSelfRef.test_ascon_core__DOT__CIPHERTEXT
                    .at(vlSelfRef.test_ascon_core__DOT__count), __Vtemp_15);
        vlSelfRef.test_ascon_core__DOT__count = ((IData)(1U) 
                                                 + vlSelfRef.test_ascon_core__DOT__count);
        vlSelfRef.test_ascon_core__DOT__unnamedblk5__DOT__i 
            = ((IData)(2U) + vlSelfRef.test_ascon_core__DOT__unnamedblk5__DOT__i);
    }
    if (VL_UNLIKELY((0U != vlSelfRef.test_ascon_core__DOT__CIPHERTEXT.first(test_ascon_core__DOT__unnamedblk6__DOT__i)))) {
        test_ascon_core__DOT__unnamedblk6__DOT__i__Vfirst = 1U;
        while (((IData)(test_ascon_core__DOT__unnamedblk6__DOT__i__Vfirst) 
                || (0U != vlSelfRef.test_ascon_core__DOT__CIPHERTEXT.next(test_ascon_core__DOT__unnamedblk6__DOT__i)))) {
            test_ascon_core__DOT__unnamedblk6__DOT__i__Vfirst = 0U;
            VL_ASSIGN_W(128,__Vtemp_18, vlSelfRef.test_ascon_core__DOT__CIPHERTEXT
                        .at(test_ascon_core__DOT__unnamedblk6__DOT__i));
            VL_WRITEF_NX("CIPHERTEXT[%3d] = %x\n",0,
                         32,test_ascon_core__DOT__unnamedblk6__DOT__i,
                         128,__Vtemp_18.data());
        }
    }
    ...
    vlSelfRef.test_ascon_core__DOT__count = 0U;
    vlSelfRef.test_ascon_core__DOT__unnamedblk7__DOT__i = 1U;
    while (VL_LTS_III(32, vlSelfRef.test_ascon_core__DOT__unnamedblk7__DOT__i, vlSelfRef.test_ascon_core__DOT__data_read_file_message.size())) {
        VL_CONCAT_WQQ(128,64,64, __Vtemp_19, vlSelfRef.test_ascon_core__DOT__data_read_file_message
                      .at(vlSelfRef.test_ascon_core__DOT__unnamedblk7__DOT__i), 0ULL);
        VL_ASSIGN_W(128,vlSelfRef.test_ascon_core__DOT__MESSAGE
                    .at(vlSelfRef.test_ascon_core__DOT__count), __Vtemp_19);
        vlSelfRef.test_ascon_core__DOT__count = ((IData)(1U) 
                                                 + vlSelfRef.test_ascon_core__DOT__count);
        vlSelfRef.test_ascon_core__DOT__unnamedblk7__DOT__i 
            = ((IData)(1U) + vlSelfRef.test_ascon_core__DOT__unnamedblk7__DOT__i);
    }
    if (VL_UNLIKELY((0U != vlSelfRef.test_ascon_core__DOT__MESSAGE.first(test_ascon_core__DOT__unnamedblk8__DOT__i)))) {
        test_ascon_core__DOT__unnamedblk8__DOT__i__Vfirst = 1U;
        while (((IData)(test_ascon_core__DOT__unnamedblk8__DOT__i__Vfirst) 
                || (0U != vlSelfRef.test_ascon_core__DOT__MESSAGE.next(test_ascon_core__DOT__unnamedblk8__DOT__i)))) {
            test_ascon_core__DOT__unnamedblk8__DOT__i__Vfirst = 0U;
            VL_ASSIGN_W(128,__Vtemp_22, vlSelfRef.test_ascon_core__DOT__MESSAGE
                        .at(test_ascon_core__DOT__unnamedblk8__DOT__i));
            VL_WRITEF_NX("MESSAGE[%3d] = %x\n",0,32,
                         test_ascon_core__DOT__unnamedblk8__DOT__i,
                         128,__Vtemp_22.data());
        }
    }
    vlSelfRef.test_ascon_core__DOT__count = 0U;
    vlSelfRef.test_ascon_core__DOT__unnamedblk9__DOT__i = 0U;
    while (VL_LTS_III(32, vlSelfRef.test_ascon_core__DOT__unnamedblk9__DOT__i, vlSelfRef.test_ascon_core__DOT__data_read_file_hash_out.size())) {
        VL_CONCAT_WQQ(128,64,64, __Vtemp_23, vlSelfRef.test_ascon_core__DOT__data_read_file_hash_out
                      .at(vlSelfRef.test_ascon_core__DOT__unnamedblk9__DOT__i), 0ULL);
        VL_ASSIGN_W(128,vlSelfRef.test_ascon_core__DOT__HASH_OUT
                    .at(vlSelfRef.test_ascon_core__DOT__count), __Vtemp_23);
        vlSelfRef.test_ascon_core__DOT__count = ((IData)(1U) 
                                                 + vlSelfRef.test_ascon_core__DOT__count);
        vlSelfRef.test_ascon_core__DOT__unnamedblk9__DOT__i 
            = ((IData)(1U) + vlSelfRef.test_ascon_core__DOT__unnamedblk9__DOT__i);
    }
    if (VL_UNLIKELY((0U != vlSelfRef.test_ascon_core__DOT__HASH_OUT.first(test_ascon_core__DOT__unnamedblk10__DOT__i)))) {
        test_ascon_core__DOT__unnamedblk10__DOT__i__Vfirst = 1U;
        while (((IData)(test_ascon_core__DOT__unnamedblk10__DOT__i__Vfirst) 
                || (0U != vlSelfRef.test_ascon_core__DOT__HASH_OUT.next(test_ascon_core__DOT__unnamedblk10__DOT__i)))) {
            test_ascon_core__DOT__unnamedblk10__DOT__i__Vfirst = 0U;
            VL_ASSIGN_W(128,__Vtemp_26, vlSelfRef.test_ascon_core__DOT__HASH_OUT
                        .at(test_ascon_core__DOT__unnamedblk10__DOT__i));
            VL_WRITEF_NX("HASH_OUT[%3d] = %x\n",0,32,
                         test_ascon_core__DOT__unnamedblk10__DOT__i,
                         128,__Vtemp_26.data());
        }
    }

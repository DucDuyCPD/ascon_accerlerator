...
#ifndef VERILATED_VTEST_ASCON_CORE_H_
#define VERILATED_VTEST_ASCON_CORE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_ascon_core VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vtest_ascon_core___024root* const rootp;
    ...
    explicit Vtest_ascon_core(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vtest_ascon_core(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vtest_ascon_core();
  private:
    VL_UNCOPYABLE(Vtest_ascon_core);  ///< Copying not allowed

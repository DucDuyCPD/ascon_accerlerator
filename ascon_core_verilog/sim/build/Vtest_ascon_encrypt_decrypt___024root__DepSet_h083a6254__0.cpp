...
VlCoroutine Vtest_ascon_encrypt_decrypt___024root___eval_initial__TOP__Vtiming__0(Vtest_ascon_encrypt_decrypt___024root* vlSelf);
VlCoroutine Vtest_ascon_encrypt_decrypt___024root___eval_initial__TOP__Vtiming__1(Vtest_ascon_encrypt_decrypt___024root* vlSelf);
...
void Vtest_ascon_encrypt_decrypt___024root___eval_initial(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___eval_initial\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vtest_ascon_encrypt_decrypt___024root___eval_initial__TOP(vlSelf);
    vlSelfRef.__Vm_traceActivity[1U] = 1U;
    Vtest_ascon_encrypt_decrypt___024root___eval_initial__TOP__Vtiming__0(vlSelf);
    Vtest_ascon_encrypt_decrypt___024root___eval_initial__TOP__Vtiming__1(vlSelf);
...
VL_INLINE_OPT VlCoroutine Vtest_ascon_encrypt_decrypt___024root___eval_initial__TOP__Vtiming__1(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_ascon_encrypt_decrypt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___eval_initial__TOP__Vtiming__1\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    while (1U) {
        co_await vlSelfRef.__VdlySched.delay(0xc350ULL, 
                                             nullptr, 
                                             "../tb/test_ascon_encrypt_decrypt.sv", 
                                             174);
        vlSelfRef.test_ascon_encrypt_decrypt__DOT__clk 
            = (1U & (~ (IData)(vlSelfRef.test_ascon_encrypt_decrypt__DOT__clk)));
    }
}

VL_INLINE_OPT void Vtest_ascon_encrypt_decrypt___024root___act_sequent__TOP__0(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_ascon_encrypt_decrypt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___act_sequent__TOP__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_INLINE_OPT void Vtest_ascon_encrypt_decrypt___024root___nba_sequent__TOP__0(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_ascon_encrypt_decrypt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___nba_sequent__TOP__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ test_ascon_encrypt_decrypt__DOT__ascon_process_associated_data_dut__DOT____VdfgRegularize_h134055a9_0_0;
    test_ascon_encrypt_decrypt__DOT__ascon_process_associated_data_dut__DOT____VdfgRegularize_h134055a9_0_0 = 0;
...
VL_INLINE_OPT void Vtest_ascon_encrypt_decrypt___024root___nba_sequent__TOP__3(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_ascon_encrypt_decrypt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___nba_sequent__TOP__3\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.test_ascon_encrypt_decrypt__DOT__ascon_process_associated_data_dut__DOT__x0_p8 
        = (vlSelfRef.test_ascon_encrypt_decrypt__DOT__ascon_process_associated_data_dut__DOT__ascon_p8__DOT__r7__DOT__x0_s 
...
void Vtest_ascon_encrypt_decrypt___024root___timing_resume(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_ascon_encrypt_decrypt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___timing_resume\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
bool Vtest_ascon_encrypt_decrypt___024root___eval_phase__act(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_ascon_encrypt_decrypt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___eval_phase__act\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlTriggerVec<3> __VpreTriggered;
    CData/*0:0*/ __VactExecute;
    // Body
    Vtest_ascon_encrypt_decrypt___024root___eval_triggers__act(vlSelf);
    __VactExecute = vlSelfRef.__VactTriggered.any();
    if (__VactExecute) {
        __VpreTriggered.andNot(vlSelfRef.__VactTriggered, vlSelfRef.__VnbaTriggered);
        vlSelfRef.__VnbaTriggered.thisOr(vlSelfRef.__VactTriggered);
        Vtest_ascon_encrypt_decrypt___024root___timing_resume(vlSelf);
        Vtest_ascon_encrypt_decrypt___024root___eval_act(vlSelf);
    }
...
bool Vtest_ascon_encrypt_decrypt___024root___eval_phase__nba(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_ascon_encrypt_decrypt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___eval_phase__nba\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    if (__VnbaExecute) {
        Vtest_ascon_encrypt_decrypt___024root___eval_nba(vlSelf);
...
void Vtest_ascon_encrypt_decrypt___024root___eval(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_ascon_encrypt_decrypt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___eval\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            Vtest_ascon_encrypt_decrypt___024root___dump_triggers__nba(vlSelf);
#endif
            VL_FATAL_MT("../tb/test_ascon_encrypt_decrypt.sv", 2, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../tb/test_ascon_encrypt_decrypt.sv", 2, "", "Active region did not converge.");
            }
            vlSelfRef.__VactIterCount = ((IData)(1U) 
                                         + vlSelfRef.__VactIterCount);
            vlSelfRef.__VactContinue = 0U;
            if (Vtest_ascon_encrypt_decrypt___024root___eval_phase__act(vlSelf)) {
                vlSelfRef.__VactContinue = 1U;
            }
        }
        if (Vtest_ascon_encrypt_decrypt___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
...
void Vtest_ascon_encrypt_decrypt___024root___eval_debug_assertions(Vtest_ascon_encrypt_decrypt___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_ascon_encrypt_decrypt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_ascon_encrypt_decrypt___024root___eval_debug_assertions\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
}
#endif  // VL_DEBUG

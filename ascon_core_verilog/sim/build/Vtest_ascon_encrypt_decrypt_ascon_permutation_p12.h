...
#ifndef VERILATED_VTEST_ASCON_ENCRYPT_DECRYPT_ASCON_PERMUTATION_P12_H_
#define VERILATED_VTEST_ASCON_ENCRYPT_DECRYPT_ASCON_PERMUTATION_P12_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_ascon_encrypt_decrypt_ascon_permutation_p12 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_ascon_encrypt_decrypt_ascon_permutation_p12(Vtest_ascon_encrypt_decrypt__Syms* symsp, const char* v__name);
    ~Vtest_ascon_encrypt_decrypt_ascon_permutation_p12();
    VL_UNCOPYABLE(Vtest_ascon_encrypt_decrypt_ascon_permutation_p12);

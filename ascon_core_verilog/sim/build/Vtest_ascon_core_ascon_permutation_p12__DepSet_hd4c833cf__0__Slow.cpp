...
VL_ATTR_COLD void Vtest_ascon_core_ascon_permutation_p12___stl_sequent__TOP__test_ascon_core__DOT__ascon_core_dut__DOT__ascon_hash_module__DOT__ascon_p12__0(Vtest_ascon_core_ascon_permutation_p12* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_ascon_core_ascon_permutation_p12___stl_sequent__TOP__test_ascon_core__DOT__ascon_core_dut__DOT__ascon_hash_module__DOT__ascon_p12__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__Vcellout__r0__x2_o = ((~ vlSelfRef.r0__DOT____VdfgRegularize_h66faf083_0_1) 
                                      ^ ((((QData)((IData)(
                                                           (1U 
                                                            & (~ (IData)(vlSelfRef.r0__DOT____VdfgRegularize_h66faf083_0_1))))) 
                                           << 0x3fU) 
